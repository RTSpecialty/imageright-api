(function (global, factory) {
	...
	(global['imageright-api'] = factory(global.axios));
...
function authenticate(baseURL, UserName, Password) {
  ...
  return axios.post('api/authenticate', { UserName: UserName, Password: Password }, config).then(function (res) {
    return { AccessToken: res.data };
  });
}

var VERSION$1 = '6.2.23.1417';

var ImageRight = function () {
  function ImageRight(baseUrl, AccessToken) {
    _classCallCheck(this, ImageRight);
...
var Library = function () {
  ...
  _createClass(Library, [{
    ...
    value: function createAPI(_ref) {
      ...
      return _Promise.resolve(this.api);
    }
  }, {
    key: 'connect',
