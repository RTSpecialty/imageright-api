...
describe('Given an instance of the library', () => {
  ...
  describe('when connected', () => {
    ...
    it('the api should have a version', () =>
      connected.then((api) => expect(api.version).to.be.equal(apiVersion)));
    it('the api should have the BaseUrl', () =>
      connected.then((api) => expect(api.baseUrl).to.be.equal(baseurl)));
    it('the api should have an AccessToken', () =>
      connected.then((api) => expect(api.AccessToken).to.exist));
  });
});
